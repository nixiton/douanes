...
<li class="">
  <a href="?content=content/ordre_sortie&menu=edition_etat">
    <i class="fa fa-sign-in"></i>
    <span class="link-title">Ordre de Sortie</span>
...
<li class="">
  <a href="?content=content/ordre_entree&menu=edition_etat">
    <i class="fa fa-sign-out"></i>
    <span class="link-title">Ordre d'Entrée</span>
